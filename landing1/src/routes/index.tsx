...
import phoneImg from "@/assets/phone-mockup.jpg";
      ...
      <header className="fixed top-0 inset-x-0 z-50 backdrop-blur-xl bg-background/70 border-b border-border/50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <a href="#cta" className="inline-flex items-center gap-1.5 rounded-full bg-[image:var(--gradient-primary)] px-4 py-2 text-sm font-semibold text-primary-foreground shadow-[var(--shadow-glow)] hover:opacity-90 transition">
        ...
        {open && (
          <div className="md:hidden border-t border-border/50 bg-background/95 backdrop-blur">
            <div className="px-4 py-4 flex flex-col gap-3 text-sm">
              ...
              <a href="#cta" onClick={() => setOpen(false)} className="rounded-full bg-primary text-primary-foreground text-center py-2 font-semibold mt-2">Get Started</a>
            </div>
          </div>
        )}
      </header>
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 grid lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
          <div className="min-w-0">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a href="#cta" className="inline-flex items-center gap-2 rounded-full bg-[image:var(--gradient-primary)] px-6 py-3.5 text-sm font-semibold text-primary-foreground shadow-[var(--shadow-glow)] hover:scale-[1.02] transition">
      ...
      <section id="how" className="py-20 md:py-28 bg-surface/40 border-y border-border/60">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 grid lg:grid-cols-2 gap-14 items-center">
          <div className="relative order-2 lg:order-1">
            ...
            <img src={phoneImg} alt="Check It device registry app" width={1000} height={1400} loading="lazy"
              className="relative rounded-3xl border border-border shadow-[var(--shadow-card)] w-full object-cover max-h-[600px]" />
          </div>
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          <div className="relative rounded-3xl border border-border bg-surface/60 p-8 md:p-12 overflow-hidden">
            ...
            <div className="relative">
              ...
              <form onSubmit={(e) => e.preventDefault()} className="mt-8 grid grid-cols-[minmax(0,1fr)_auto] gap-2 sm:flex">
                <input
                  value={imei}
                ...
                />
                <button className="inline-flex items-center gap-2 rounded-full bg-[image:var(--gradient-primary)] px-6 py-3.5 text-sm font-semibold text-primary-foreground shadow-[var(--shadow-glow)] shrink-0">
      ...
      <section id="cta" className="py-20 md:py-28">
        <div className="mx-auto max-w-5xl px-4 sm:px-6">
          <div className="relative overflow-hidden rounded-3xl border border-primary/30 p-10 md:p-16 text-center" style={{ background: "var(--gradient-hero)" }}>
            <div className="absolute inset-0 opacity-20" style={{ backgroundImage: `url(${heroImg})`, backgroundSize: "cover" }} aria-hidden />
            <div className="relative">
              ...
              <div className="mt-8 flex flex-wrap justify-center gap-3">
                <a href="#" className="inline-flex items-center gap-2 rounded-full bg-[image:var(--gradient-primary)] px-7 py-4 text-sm font-semibold text-primary-foreground shadow-[var(--shadow-glow)]">
